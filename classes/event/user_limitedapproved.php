...
class user_limitedapproved extends base
{
    ...
    {
        return "External user with id " . $this->other['userid'] . " has been changed to limited approved status until " . $this->other['newstatus']
            . ". (was " . $this->other['oldstatus'] . ")";
    }
    ...
    {
        return get_string("event_limitedapproved", "local_external_users");
    }
    ...
    protected function get_legacy_logdata()
    {
        ...
        $info = "External Users";
        $eventname = get_string("event_limitedapproved",
            "local_external_users");
        $userid = $this->userid;
        $cmid = $this->objectid;
        $courseid = $this->courseid;
        $action = "user_limitedapproved";
        $description = "External user with id " . $this->other['userid'] . " has been changed to limited approved status.";
