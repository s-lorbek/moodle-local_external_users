...
/**
 * TODO describe file manage_verified
 *
...
$PAGE->set_url(new moodle_url('/local/external_users/manage_verified.php'));
...
$manageverified = new \local_external_users\manage_verified();
$manageverified->render();
