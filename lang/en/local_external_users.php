...
$string['affiliation_help'] = 'Changes to affiliation are saved automatically.';
...
$string['comment_placeholder'] = 'Enter optional feedback for the user...';
$string['controls'] = 'Actions & Controls';
$string['details'] = 'Details';
$string['download'] = 'Download';
$string['edupersonscopedaffiliation'] = 'eduPersonScopedAffiliation';
...
$string['pending_status_description'] = "We have received your documents. Our team is now carefully reviewing them.";
$string['pending_status_next_steps'] = "As soon as your application has been processed, you will receive a notification by email.";
$string['pending_status_title'] = "Registration Status";
...
$string['verifiedtill'] = 'Verified until';
