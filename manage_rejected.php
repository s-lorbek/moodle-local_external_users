...
/**
 * TODO describe file manage_rejected
 *
...
$PAGE->set_url(new moodle_url('/local/external_users/manage_rejected.php'));
...
$managerejected = new \local_external_users\manage_rejected();
$managerejected->render();
