...
class user_rejected extends base
{
    ...
    {
        return "External user with id " . $this->other['userid'] . " has been changed to rejected status. (was "
    ...
    {
        return get_string("event_rejected", "local_external_users");
    }
    ...
    protected function get_legacy_logdata()
    {
        ...
        $info = "External Users";
        $eventname = get_string("event_rejected", "local_external_users");
        $userid = $this->userid;
        $cmid = $this->objectid;
