...
/**
 * TODO describe file manage_pending
 *
...
$PAGE->set_url(new moodle_url('/local/external_users/manage_pending.php'));
...
$managepending = new \local_external_users\manage_pending();
$managepending->render();
